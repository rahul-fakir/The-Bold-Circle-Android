                            ...
                            if (result.getStatus()) {
                                ...
                                if (result.getStatus()) {
                                    if (etEmail.getText().toString().equals(etConfirmEmail.getText().toString())) {
                                        System.out.println("jhghakgkadkjgfdkjgfdkhdk");
                                        ...
                                        ref.createUser(etEmail.getText().toString(), etPassword.getText().toString(),
                                                new Firebase.ValueResultHandler<Map<String, Object>>() {
                                                    ...
                                                    public void onSuccess(Map<String, Object> result) {
                                                        ...
                                                        userObject.put("first_name", etFirstName.getText().toString());
                                                        userObject.put("surname", etSurname.getText().toString());
                                                        userObject.put("mobile_number", etMobileNumber.getText().toString());
                                                        userObject.put("email", etEmail.getText().toString());
                                        ...
                                        Toast.makeText(getApplicationContext(), "Email's do not match",
                                                Toast.LENGTH_LONG).show();
                                    }
